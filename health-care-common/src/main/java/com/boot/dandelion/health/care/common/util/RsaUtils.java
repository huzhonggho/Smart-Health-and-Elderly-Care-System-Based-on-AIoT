...
public class RsaUtils {
    ...
    private static void test3() throws Exception {
        System.out.println("***************** 公钥加密私钥解密开始 *****************");
        String rsaPublicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCcvIp81yykTvT3e/GeTTElMxOJa846EeN3oI/XieiaoAZx7ERCY8FO9NwGa4KWRGWJztA9KT1ATWh/Ut+89g/zZmatyQEexFJ9ki7t+NsG/HdSwQFL/dhwp+ILllbwQMgat//6UMDk5tWUkuH6/1OJwTxMU8+TzFyMdHIQhC1gAQIDAQAB";;
        String rsaPrivateKey = "MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwgg" +
        ...
        String text1 = encryptByPublicKey(rsaPublicKey, RsaUtils.SRC);
        String text2 = decryptByPrivateKey(rsaPrivateKey, text1);
        System.out.println("加密前：" + RsaUtils.SRC);
        System.out.println("加密后：" + text1);
        System.out.println("加密后密码长度："+ text1.length());
        System.out.println("解密后：" + text2);
        if (RsaUtils.SRC.equals(text2)) {
            System.out.println("解密字符串和原始字符串一致，解密成功");
        } else {
